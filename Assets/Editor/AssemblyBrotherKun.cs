namespace UTJ
{
    ...
    public class AssemblyBrotherKun : EditorWindow
    {
        ...
        public static void ShowExample()
        {
            ...
            wnd.titleContent = new GUIContent("AssemblyBrotherKun");
        }
        ...
        public void OnEnable()
        {
            ...
            // Import UXML
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Editor/AssemblyBrotherKun.uxml");
            VisualElement labelFromUXML = visualTree.CloneTree();
            root.Add(labelFromUXML);

            // A stylesheet can be added to a VisualElement.
            // The style will be applied to the VisualElement and all of its children.
            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Editor/AssemblyBrotherKun.uss");
